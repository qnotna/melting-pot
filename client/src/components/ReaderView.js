...
class ReaderView extends Component {
  ...
  article = {
    ...
    content: {
      ...
      imgSrc: 'https://static01.nyt.com/images/2019/11/06/us/06mormon-kids01alt/06mormon-kids01alt-superJumbo.jpg?quality=90&auto=webp',
      imgAlt: 'Relatives of a family killed in an ambush looked through the burnt wreckage of one of the vehicles that had been carrying them in Bavispe, Mexico.',
      text: `PHOENIX — About 10 hours after the massacre that claimed the lives of his grandchildren, Kenneth Miller drove his ATV through the northern Mexico wilderness in a frantic search for one last missing relative — a 9-year-old girl who had gone in search of help.
      ...
      ImageDawna Langford, 43, and her son Trevor Langford, 11, were killed in the attack.
  ...
  render() {
    return(
      <div id='reader-view'>
        <img src={this.article.content.imgSrc} alt={this.article.content.imgAlt}/>
        <div id='reader-view-meta'>
          <div/>
        </div>
        <div id='reader-view-content'>
          <h1>{this.article.content.title}</h1>
          <h3>{this.article.content.previewText}</h3>
          {this.createText(this.article.content.text)}
        </div>
      </div>
    );
  }
